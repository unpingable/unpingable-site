...
two revisions, two structural check receipts and one lock receipt. The operator
must establish quiescence before export. The exporter refuses sidecars,
a wrong source hash, wrong selected identity,
